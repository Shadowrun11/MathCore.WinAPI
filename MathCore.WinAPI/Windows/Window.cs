...
namespace MathCore.WinAPI.Windows
{
    public class Window
    {
        ...
        public static IntPtr SendMessage(IntPtr Handle, WM Message, IntPtr wParam, IntPtr lParam) => User32.SendMessage(Handle, Message, wParam, lParam);
        ...
        public IntPtr PostMessage(WM Message, IntPtr wParam, IntPtr lParam) => User32.PostMessage(Handle, Message, wParam, lParam);
        private string GetWindowsText()
        {
        ...
        {
            return User32.SetWindowPos(Handle,
                set
                ? InsertAfterEnumHWND.TopMost :
                 InsertAfterEnumHWND.NoTopMost,
                0, 0, 0, 0,
