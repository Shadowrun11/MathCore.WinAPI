...
namespace MathCore.WinAPI.pInvoke
{
    public static class User32
    {
        ...
        /// <summary>
        /// Число символов текста окна
        /// </summary>
        /// <param name="hWdh">Дескрипт окна</param>
        /// <returns></returns>
        [DllImport(FileName, SetLastError = true, CharSet = CharSet.Auto)]
        public static extern int GetWindowTextLength(IntPtr hWdh);
        ...
        /// <param name="nMaxCount">Число</param>
        /// <returns></returns>
        [DllImport(FileName, CharSet = CharSet.Auto, SetLastError = true)]
        public static extern int GetWindowText(IntPtr hWdh, StringBuilder lpString, uint nMaxCount);

        [DllImport(FileName, SetLastError = true)]
        public static extern int EnumWindows(EnumWindowProc hWdh, IntPtr lParam);
        ...
        [DllImport(FileName, SetLastError = true)]
        public static extern bool SetWindowText(IntPtr hWdh, string lpString);

        [DllImport(FileName, SetLastError = true)]
        public static extern bool GetWindowRect(IntPtr hWdh, ref RECT lpRect);
        ...
        [DllImport(FileName, SetLastError = true)]
        public static extern bool MoveWindow(IntPtr hWdh, int X, int Y, int nWidth, int nHeight, bool bRepaint);
